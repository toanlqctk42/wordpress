	...
	<?php if ( has_post_thumbnail() ) : ?>
		...
		<?php else : ?>
			...
			<div class="content-wrapper">
				...
				<?php if (get_theme_mod('show_post_excerpt') == '1') : ?>   
					<div class="entry-content">
						<?php
						the_excerpt( sprintf(
							wp_kses(
								/* translators: %s: Name of current post. Only visible to screen readers */
								__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'image-shareify' ),
								array(
									'span' => array(
										'class' => array(),
									),
						...
						wp_link_pages( array(
							'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'image-shareify' ),
							'after'  => '</div>',
						) );
						?>
